...
static const char *const yytname[] =
{
  ...
  "NUMBER", "EQUAL", "$accept", "total", "expression", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* total: expression EQUAL  */
#line 24 "parser.y"
                                             {  std::cout <<  yyvsp[-1] << std::endl;   }
#line 1067 "parser.tab.c"
    break;

  case 3: /* expression: expression expression PLUS  */
#line 27 "parser.y"
                                             {  yyval = yyvsp[-2] + yyvsp[-1];   }
#line 1073 "parser.tab.c"
    break;

  case 4: /* expression: expression expression TIMES  */
#line 28 "parser.y"
                                             {  yyval = yyvsp[-2] * yyvsp[-1];   }
